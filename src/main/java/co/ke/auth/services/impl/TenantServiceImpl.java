...
import co.ke.auth.entities.*;
import co.ke.auth.models.*;
import co.ke.auth.repositories.*;
import co.ke.auth.services.TenantService;
            ...
            if ((tenant.getId() == null && roleRepositoryName == null) || (tenant.getId() != null && tenant.getName().equals(roleRepositoryName.getName()))) {
                ...
                if (tenantDTo.getId() == null) {
                    if (createUSer || createAdminUser) {
                        ...
                        AppResponseModel createdUser = userService.createUpdateUsers(tenant.getAppKey(), UserDto.transform(tenantDTo, adminRole.getId(),adminRole.getPermissions()),2);
